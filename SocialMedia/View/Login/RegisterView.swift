    ...
    func registerUser() {
        ...
        Task {
            do {
                ...
                // MARK: What's this error?
                // The operation couldn't be completed. (FirebaseStorage. StorageError error 1.)
                // Because we only enabled Firebase Auth
                // and did not enable Firebase Storage or Firebase Firestore,
