...
struct ProfileView: View {
    ...
    var body: some View {
        ...
        .task {
            ...
            /// Since Task is an alternative to onAppear, which is an async Call,
            /// whenever the tab is changed and reopend, it will be called like onAppear.
            /// That's why we're limiting ti to the inital fetch (First Time).
